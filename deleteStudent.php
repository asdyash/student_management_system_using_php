...
if (isset($_POST['delete'])) {
    ...
    $delete_stmt->bind_param("s", $st_id);

    if ($delete_stmt->execute()) {
        $success_msg = "Student deleted successfully!";
        // Clear student data after successful delete
        $student = null;
    } else {
    ...
    <ul class="nav-links">
        ...
        <li>
            <a href="deleteStudent.php">
                ...
                <span class="link_name">Delete Student</span>
            </a>
        </li>
    </ul>
</div>
    ...
    <div class="container">
        ...
        <?php if ($student): ?>
            <form method="post" class="form-horizontal">
                ...
                <p>Are you sure you want to delete the student <strong><?php echo $student['st_name']; ?></strong>?</p>
                <div class="form-group">
                    <input type="submit" value="Delete" name="delete">
                    <a href="deleteStudent.php" style="color: #dc3545; margin-left: 15px;">Cancel</a>
                </div>
            </form>
        <?php endif; ?>
    </div>
